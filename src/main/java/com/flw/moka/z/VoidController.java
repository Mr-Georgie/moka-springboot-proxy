...
// @PostMapping(path = "/void", consumes = "application/json", produces =
// "application/json")
// public ResponseEntity<ProxyResponse> saveCardParams(@RequestBody
// ProductRequest productRequest)
// throws URISyntaxException, ParseException {

// PaymentDealerRequest newPaymentDealerRequest =
// paymentDealerRequestService.createRequestPayload(
// productRequest,
// Methods.VOID);
