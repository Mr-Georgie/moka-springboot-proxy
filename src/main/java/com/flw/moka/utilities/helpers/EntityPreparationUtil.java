...
public class EntityPreparationUtil {
    ...
    public Logs setLogs(ProxyResponse proxyResponse, ProductRequest productRequest) {
    ...
    public Transaction setTransaction(ProductRequest productRequest, ProxyResponse proxyResponse,
